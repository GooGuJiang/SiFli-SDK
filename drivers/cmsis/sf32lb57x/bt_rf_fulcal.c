...
CONST static uint16_t rxon_cmd[] =
{
    ...
    RD_FULCAL, WR(0x08),
    // VCO5G_EN
    RD(0x0), OR(14), WR(0x0), // 11
    // PFDCP_EN
    RD(0x1C), OR(20), WR(0x1C),
    // FBDV_EN
    RD(0X14), OR(13), WR(0X14), //17
    // FBDV_RSTB
...
CONST static uint16_t rxoff_cmd[] =
{
    ...
    // VCO5G_EN & VCO_FLT_EN
    RD(0X0), AND(14), AND(8), WR(0x00),
    //FBDV_EN
    //FBDV RSTB
    RD(0x14), AND(13), OR(7), WR(0x14), // 14
    //PFDCP_EN
    RD(0x1C), AND(20), WR(0x1C),
...
CONST static uint16_t txon_cmd[] =
{
    ...
    RD(0x0), OR(14), WR(0x0), // 11
    // FBDV_EN
    RD(0X14), OR(13), WR(0X14),
    // PFDCP_EN
    RD(0x1C), OR(20), WR(0x1C), // 17
    // FBDV_RSTB
    RD(0X14), AND(7), WR(0X14),
    // wait 30us for lo lock
    WAIT(30), //21
...
CONST static uint16_t txoff_cmd[] =
{
    ...
    OR(7), WR(0x14),
    //PFDCP_EN
    RD(0x1C), AND(20), WR(0x1C), // 17
    //PA_BUF_PU & PA_OUT_PU & TRF_SIG_EN
    RD(0X34), AND(31), AND(30), AND(25), WR(0X34),
    //TRF_EDR_IARRAY_EN
    ...
    //EDR_EN_OSLO
    RD(0X28), AND(12), WR(0X28),
    //VCO3G_EN/EDR_VCO_FLT_EN
    RD(0X0), AND(15), AND(8), WR(0X0), // 48
    //EDR_FBDV_RSTB
    ...
    RD(0X14), AND(13), OR(5), AND(4), OR(3), WR(0X14),
...
CONST static uint16_t bt_txon_cmd[] =
{
    ...
    // RD FULCAL
    RD_FULCAL, WR(0X24), // 12
    RD_FULCAL + 0x800, WR(0X8), // 12
    // VCO3G_EN
    RD(0x0), OR(15), WR(0x0),
    ...
    RD(0x14), OR(13), AND(5), OR(4), AND(3), WR(0x14),
    // FBDV_RSTB
    RD(0X14), AND(7), WR(0X14), // 29
    // ACAL_VH_SEL=7/ACAL_VL_SEL=5
    RD(0X04), OR(2), OR(6), WR(0X04),
    // EDR_VCO_FLT_EN
    RD(0X0), OR(8), WR(0X0), // 36
    //EDR_EN_OSLO
    RD(0X28), OR(12), WR(0X28),
    // LODISTEDR_EN
...
CONST static uint16_t bt_txoff_cmd[] =
{
    ...
    //VCO5G_EN & VCO_FLT_EN
    RD(0X0), AND(14), AND(8), WR(0X0), // 78-ATE, 79-NOATE
    //FBDV_EN
    RD(0X14), AND(13),
    //FBDV_RSTB
    ...
    //PA_BUF_PU & PA_OUT_PU & TRF_SIG_EN
    RD(0X34), AND(25), AND(30), AND(31), WR(0x34), // 90-ATE, 91-NOATE
...
#error "Must defined frequency"
    ...
    */
    ...
    bt_txon_cmd[i++] = OR(17) ;
    bt_txon_cmd[i++] = OR(18) ;
    bt_txon_cmd[i++] = OR(5) ;   //LODISTEDR_TX_SEL
    bt_txon_cmd[i++] = OR(7) ;   //LODIST5G_EDRTX_EN
...
uint32_t bt_rfc_lo_cal(uint32_t rslt_start_addr)
{
    ...
    /*
      uint8_t idac_tbl_tx[79 * 4];
    uint8_t idac_tbl_rx_2m[40 * 4];
    uint8_t idac_tbl_rx_1m[40 * 4];
    uint8_t idac_tbl_rx_bt = malloc(79 * 4);

    uint8_t capcode_tbl_tx[79 * 4];
    uint8_t capcode_tbl_rx_2m[40 * 4];
    uint8_t capcode_tbl_rx_1m[40 * 4];
    uint8_t capcode_tbl_rx_bt[79 * 4];
    */
    ...
    hwp_bt_rfc->RF_LODIST_REG |= BT_RFC_RF_LODIST_REG_BRF_EN_VDDPSW_LV | BT_RFC_RF_LODIST_REG_BRF_LO_IARY_EN_LV | BT_RFC_RF_LODIST_REG_BRF_EN_RF_IARRAY_LV;

    //BT_RFC_RF_LODIST_REG_BRF_EN_RFBG_LV, make sure cau bg is 1
    ...
    hwp_bt_rfc->VCO_REG1 |= BT_RFC_VCO_REG1_BRF_VCO5G_EN_LV | BT_RFC_VCO_REG1_BRF_EN_2M_MOD_LV |
                            (0xB << BT_RFC_VCO_REG1_BRF_VCO_LDO_VREF_LV_Pos);
    ...
    hwp_bt_phy->TX_HFP_CFG2 &= ~(BT_PHY_TX_HFP_CFG2_HFP_FCW_Msk);
    hwp_bt_phy->TX_HFP_CFG2 |= (0x1f << BT_PHY_TX_HFP_CFG2_HFP_FCW_Pos);//TODO: bit width update
    ...
    hwp_bt_rfc->FBDV_REG1 |= BT_RFC_FBDV_REG1_BRF_FBDV_EN_LV | BT_RFC_FBDV_REG1_BRF_SDM_CLK_SEL_LV |
                             (0xb << BT_RFC_FBDV_REG1_BRF_FBDV_LDO_VREF_LV_Pos) |
    ...
    hwp_bt_phy->TX_HFP_CFG2 &= ~(BT_PHY_TX_HFP_CFG2_HFP_FCW_Msk | BT_PHY_TX_HFP_CFG1_HFP_FCW_SEL);
    hwp_bt_phy->TX_HFP_CFG2 |= (0x01f << BT_PHY_TX_HFP_CFG2_HFP_FCW_Pos);
    hwp_bt_rfc->VCO_REG1 |= BT_RFC_VCO_REG1_BRF_EN_2M_MOD_LV;
    ...
    hwp_bt_rfc->VCO_REG2    |= BT_RFC_VCO_REG2_BRF_VCO_FKCAL_EN_LV;
    hwp_bt_rfc->FBDV_REG2   &= ~BT_RFC_FBDV_REG2_BRF_FKCAL_CNT_DIVN_LV ;
    hwp_bt_rfc->FBDV_REG2   |= 21120 << BT_RFC_FBDV_REG2_BRF_FKCAL_CNT_DIVN_LV_Pos;
    hwp_bt_phy->TX_LFP_CFG &= ~(BT_PHY_TX_LFP_CFG_LFP_FCW_Msk | BT_PHY_TX_LFP_CFG_LFP_FCW_SEL);
    hwp_bt_phy->TX_LFP_CFG |= (0x08 << BT_PHY_TX_LFP_CFG_LFP_FCW_Pos);
    ...
    hwp_bt_phy->TX_HFP_CFG1 &= ~(BT_PHY_TX_HFP_CFG1_HFP_FCW_SEL);
    hwp_bt_phy->TX_HFP_CFG2 &= ~(BT_PHY_TX_HFP_CFG2_HFP_FCW_Msk);
    hwp_bt_phy->TX_HFP_CFG2 |= (0x00 << BT_PHY_TX_HFP_CFG2_HFP_FCW_Pos);
    ...
    hwp_bt_phy->TX_HFP_CFG2 &= ~(BT_PHY_TX_HFP_CFG2_HFP_FCW_Msk);
    hwp_bt_phy->TX_HFP_CFG2 |= (0x3ff << BT_PHY_TX_HFP_CFG2_HFP_FCW_Pos);
    ...
    {
        //store tx cal result
        reg_data = (0x1f << BT_RFC_VCO_REG3_DIG_GAIN1_Pos) + (kcal_tbl[i] << BT_RFC_VCO_REG3_TX_KCAL_Pos) + (idac_tbl_tx[i] << BT_RFC_VCO_REG3_BRF_VCO_IDAC_LV_Pos) + (capcode_tbl_tx[i] << BT_RFC_VCO_REG3_BRF_VCO_PDX_LV_Pos) ;
        write_memory(reg_addr + BT_RFC_MEM_BASE, reg_data);
        reg_addr += 4;
    }
    ...
    hwp_bt_phy->TX_HFP_CFG1   |=  BT_PHY_TX_HFP_CFG1_HFP_FCW_SEL;
    hwp_bt_rfc->VCO_REG1      &= ~BT_RFC_VCO_REG1_BRF_EN_2M_MOD_LV;
    hwp_bt_rfc->TRF_REG2      |= BT_RFC_TRF_REG2_BRF_PA_CAS_BP_LV;
    ...
    while (!(hwp_bt_rfc->ROSCAL_REG2 & BT_RFC_ROSCAL_REG2_ROSCAL_DONE)); //TODO
    ...
    */
    ...
    //after calibration
    hwp_bt_rfc->RF_LODIST_REG &= ~(BT_RFC_RF_LODIST_REG_BRF_EN_VDDPSW_LV | BT_RFC_RF_LODIST_REG_BRF_EN_RF_IARRAY_LV);
    hwp_bt_rfc->FBDV_REG1 |= BT_RFC_FBDV_REG1_BRF_FBDV_RSTB_LV ;
...
uint32_t bt_rfc_edrlo_3g_cal(uint32_t rslt_start_addr)
{
    ...
    hwp_bt_rfc->RF_LODIST_REG &= ~BT_RFC_RF_LODIST_REG_BRF_EN_RF_IARRAY_LV ;
...
//    hwp_lpsys_rcc->CFGR |= 2 << LPSYS_RCC_CFGR_HDIV1_Pos;
...
#endif
    {
        ...
        hwp_bt_rfc->IQ_PWR_REG2 &= ~BT_RFC_IQ_PWR_REG2_BRF_TRF_EDR_PA_BM_LV;
        hwp_bt_rfc->IQ_PWR_REG2 |= 0x1B << BT_RFC_IQ_PWR_REG2_BRF_TRF_EDR_PA_BM_LV_Pos;
        ...
        */
        ...
        //fix coef
        hwp_bt_rfc->IQ_PWR_REG1_0  &= ~(BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF1 | BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF0);
        hwp_bt_rfc->IQ_PWR_REG1_0  |= 0x1000 <<  BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF1_Pos;
        hwp_bt_rfc->IQ_PWR_REG2_0  &= ~(BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_I | BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_Q) ;
        ...
        for (j = 0; j < 64; j++)
        {
            ...
            data += 0x7E0;
            data &= 0x7ff;
            MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG2_0, BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_I_Msk, data << BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_I_Pos);
        ...
        //fix cal offset i
        MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG2_0, BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_I_Msk, offset_i[i] << BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_I_Pos);
        //hwp_bt_rfc->IQ_PWR_REG2  &= ~BT_RFC_IQ_PWR_REG2_TX_DC_CAL_OFFSET_I;
        ...
        for (j = 0; j < 64; j++)
        {
            ...
            data += 0x7e0;
            data &= 0x7ff;
            MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG2_0, BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_Q_Msk, data << BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_Q_Pos);
        ...
        MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG2_0, BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_Q_Msk, offset_q[i] << BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_Q_Pos);
        //hwp_bt_rfc->IQ_PWR_REG2  &= ~BT_RFC_IQ_PWR_REG2_TX_DC_CAL_OFFSET_Q;
        ...
        for (j = 0; j < 64; j++)
        {
            ...
            data += 0x7e0;
            data &= 0x7ff;
            MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG2_0, BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_Q, data << BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_Q_Pos);
            //hwp_bt_rfc->IQ_PWR_REG2  &= ~BT_RFC_IQ_PWR_REG2_TX_DC_CAL_OFFSET_Q;
            //hwp_bt_rfc->IQ_PWR_REG2  |= data << BT_RFC_IQ_PWR_REG2_TX_DC_CAL_OFFSET_Q_Pos;
#ifdef CODE_OPT
            mixer_pwr = bt_rfc_get_mixer_pwr(1);
        ...
        //hwp_bt_rfc->TXDC_CAL_REG2  &= ~BT_RFC_TXDC_CAL_REG2_TX_DC_CAL_OFFSET_I;
        //hwp_bt_rfc->TXDC_CAL_REG2  &= ~BT_RFC_TXDC_CAL_REG2_TX_DC_CAL_OFFSET_Q;
        MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG2_0, BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_Q, offset_q[i] << BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_Q_Pos);
        //hwp_bt_rfc->IQ_PWR_REG2  &= ~BT_RFC_IQ_PWR_REG2_TX_DC_CAL_OFFSET_Q;
        //hwp_bt_rfc->IQ_PWR_REG2  |= offset_q[i] << BT_RFC_IQ_PWR_REG2_TX_DC_CAL_OFFSET_Q_Pos;
        //hwp_bt_rfc->TXDC_CAL_REG2  |= offset_q[i] << BT_RFC_TXDC_CAL_REG2_TX_DC_CAL_OFFSET_Q_Pos;
        ...
        //fix coef1
        MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG1_0, BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF1_Msk, 0x1000 << BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF1_Pos);
        ...
        for (j = 0; j < 512; j++)
        {
            ...
            data =  0x3000 + (j << 4);
            data &= 0x3FFF;
            MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG1_0, BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF0_Msk, data << BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF0_Pos);
        ...
        //fix coef0
        MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG1_0, BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF0_Msk, coef0[i] << BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF0_Pos);
        //hwp_bt_rfc->IQ_PWR_REG1  &= ~BT_RFC_IQ_PWR_REG1_TX_DC_CAL_COEF0;
        ...
        for (j = 0; j < 128; j++)
        {
            ...
            data =  0xfc0 + (j);
            data &= 0x3FFF;
            MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG1_0, BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF1_Msk, data << BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF1_Pos);
            // hwp_bt_rfc->IQ_PWR_REG1  &= ~BT_RFC_IQ_PWR_REG1_TX_DC_CAL_COEF1;
        ...
        MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG1_0, BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF1_Msk, coef1[i] << BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF1_Pos);
        //hwp_bt_rfc->IQ_PWR_REG1  &= ~BT_RFC_IQ_PWR_REG1_TX_DC_CAL_COEF1;
    ...
    //level 4 : edr tx 13dBm
    hwp_bt_rfc->IQ_PWR_REG2_0 &= ~BT_RFC_IQ_PWR_REG2_0_BRF_TRF_EDR_PA_BM_LV;
    //hwp_bt_rfc->IQ_PWR_REG2 |= edr_pa_bm[4]<< BT_RFC_IQ_PWR_REG2_BRF_TRF_EDR_PA_BM_LV_Pos;
    hwp_bt_rfc->IQ_PWR_REG2_0 |= 7 << BT_RFC_IQ_PWR_REG2_0_BRF_TRF_EDR_PA_BM_LV_Pos;
    //hwp_bt_phy->TX_DC_CAL_CFG2 = 0x44;
    //hwp_bt_phy->TX_DC_CAL_CFG2 = 0x30;//TODO

    MODIFY_REG(hwp_bt_rfc->IQ_PWR_REG1_0, BT_RFC_IQ_PWR_REG1_0_EDR_TMXBUF_GC_GFSK_Msk, 7 << BT_RFC_IQ_PWR_REG1_0_EDR_TMXBUF_GC_GFSK_Pos);
    //hwp_bt_rfc->IQ_PWR_REG1 &= ~BT_RFC_IQ_PWR_REG1_EDR_TMXBUF_GC_GFSK ;
...
//#endif
    ...
    */
    ...
    for (i = 0; i < 8; i++)
    {
        ...
        data =  coef0[m] | (coef1[m] << BT_RFC_IQ_PWR_REG1_0_TX_DC_CAL_COEF1_Pos) | (tmxbuf_gc[i] << BT_RFC_IQ_PWR_REG1_0_EDR_TMXBUF_GC_GFSK_Pos);
        write_memory(BT_RFC_MEM_BASE + reg_addr, data);
        //rt_kprintf("rf_cal data0:0x%x\n", data);
        reg_addr += 4;
        data = 0;
        //if(!(m == 4 && bt_is_in_BQB_mode())) data |= BT_RFC_IQ_PWR_REG2_EDR_LPF_BYPASS;
        data = offset_q[m] | (offset_i[m] << BT_RFC_IQ_PWR_REG2_0_TX_DC_CAL_OFFSET_I_Pos) | \
               (tmxbuf_gc[i] << BT_RFC_IQ_PWR_REG2_0_EDR_TMXBUF_GC_DPSK_Pos) | \
               (edr_pa_bm[i] << BT_RFC_IQ_PWR_REG2_0_BRF_TRF_EDR_PA_BM_LV_Pos);
...
{
    // PA config
    hwp_bt_rfc->TRF_REG2 &= ~BT_RFC_TRF_REG2_BRF_PA_PM_LV_Msk;
    hwp_bt_rfc->TRF_REG2 &= ~BT_RFC_TRF_REG2_BRF_PA_CAS_BP_LV_Msk;

    hwp_bt_rfc->TRF_REG2 &= ~BT_RFC_TRF_REG2_BRF_PA_UNIT_SEL_LV_Msk;
    hwp_bt_rfc->TRF_REG2 &= ~BT_RFC_TRF_REG2_BRF_PA_MCAP_LV_Msk;

#if 1
    hwp_bt_rfc->TRF_REG2 |= 0x01 << BT_RFC_TRF_REG2_BRF_PA_PM_LV_Pos;
    hwp_bt_rfc->TRF_REG2 |= 0x01 << BT_RFC_TRF_REG2_BRF_PA_CAS_BP_LV_Pos;
    ...
    hwp_bt_rfc->RBB_REG1 |= (0x05 << BT_RFC_RBB_REG1_BRF_PKDET_VTH1I_BT_Pos | 0x05 << BT_RFC_RBB_REG1_BRF_PKDET_VTH1Q_BT_Pos
                             | 0x05 << BT_RFC_RBB_REG1_BRF_PKDET_VTH2I_BT_Pos | 0x05 << BT_RFC_RBB_REG1_BRF_PKDET_VTH2Q_BT_Pos);
...
void bt_rf_cal(void)
{
    ...
    hwp_bt_rfc->TMXBUF_GC_CP_FACTOR_0 = 0xf00;
...
void rf_power_config()
{
    ...
    rf_power_env->max_br_pwr = 10;
    rf_power_env->max_ble_pwr = 10;
    rf_power_env->max_edr_pwr = 10;
    rf_power_env->min_br_pwr = 10;
    rf_power_env->min_ble_pwr = 10;
    rf_power_env->min_edr_pwr = 10;
    ...
    uint32_t power0 = 0;
    rf_power_field_t *pt_power0 = (rf_power_field_t *)&power0;
    pt_power0->mod_cntl = 0;
    pt_power0->br_iq_level = 0;
    pt_power0->edr_iq_level = 0;
    pt_power0->polar_level = 0;
    pt_power0->polar_pwr = 0x3f;
    pt_power0->br_iq_pwr = 0;
    pt_power0->edr_iq_pwr = 0;
    pt_power0->pwr_dbm = 10;
