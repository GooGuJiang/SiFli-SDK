...
#define BT_PHY_TX_IF_MOD_CFG2_EDR_GGAIN_MUL_Msk  (0xFFUL << BT_PHY_TX_IF_MOD_CFG2_EDR_GGAIN_MUL_Pos)
#define BT_PHY_TX_IF_MOD_CFG2_EDR_GGAIN_MUL  BT_PHY_TX_IF_MOD_CFG2_EDR_GGAIN_MUL_Msk
#define BT_PHY_TX_IF_MOD_CFG2_GGAIN_SAT_Pos  (8U)
#define BT_PHY_TX_IF_MOD_CFG2_GGAIN_SAT_Msk  (0xFFUL << BT_PHY_TX_IF_MOD_CFG2_GGAIN_SAT_Pos)
#define BT_PHY_TX_IF_MOD_CFG2_GGAIN_SAT  BT_PHY_TX_IF_MOD_CFG2_GGAIN_SAT_Msk
#define BT_PHY_TX_IF_MOD_CFG2_DGAIN_SAT_Pos  (16U)
#define BT_PHY_TX_IF_MOD_CFG2_DGAIN_SAT_Msk  (0xFFUL << BT_PHY_TX_IF_MOD_CFG2_DGAIN_SAT_Pos)
#define BT_PHY_TX_IF_MOD_CFG2_DGAIN_SAT  BT_PHY_TX_IF_MOD_CFG2_DGAIN_SAT_Msk
#define BT_PHY_TX_IF_MOD_CFG2_EDR_GGAIN_SAT_Pos  (24U)
#define BT_PHY_TX_IF_MOD_CFG2_EDR_GGAIN_SAT_Msk  (0xFFUL << BT_PHY_TX_IF_MOD_CFG2_EDR_GGAIN_SAT_Pos)
