...
#define WDT_WDT_CR_PREINT_COUNT_Pos     (5U)
#define WDT_WDT_CR_PREINT_COUNT_Msk     (0xFFUL << WDT_WDT_CR_PREINT_COUNT_Pos)
#define WDT_WDT_CR_PREINT_COUNT         WDT_WDT_CR_PREINT_COUNT_Msk
...
#define WDT_WDT_SR_PREINT_ASSERT_Pos    (1U)
#define WDT_WDT_SR_PREINT_ASSERT_Msk    (0x1UL << WDT_WDT_SR_PREINT_ASSERT_Pos)
#define WDT_WDT_SR_PREINT_ASSERT        WDT_WDT_SR_PREINT_ASSERT_Msk
#define WDT_WDT_SR_WDT_ACTIVE_Pos       (2U)
#define WDT_WDT_SR_WDT_ACTIVE_Msk       (0x1UL << WDT_WDT_SR_WDT_ACTIVE_Pos)
#define WDT_WDT_SR_WDT_ACTIVE           WDT_WDT_SR_WDT_ACTIVE_Msk
#define WDT_WDT_SR_WDT_CNT_Pos          (3U)
#define WDT_WDT_SR_WDT_CNT_Msk          (0xFFFFFFUL << WDT_WDT_SR_WDT_CNT_Pos)
#define WDT_WDT_SR_WDT_CNT              WDT_WDT_SR_WDT_CNT_Msk
